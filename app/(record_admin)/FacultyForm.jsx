...
export default function FacultyForm() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      resetForm();
      router.push({
        pathname: '/FacultySearch',
        params: { department, schoolyear: schoolYear, semester },
      });
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <FormHeader title="Faculty Information" onMenuPress={() => setSidebarVisible(true)} />
